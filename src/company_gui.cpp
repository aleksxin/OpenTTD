...
static ExpRow gs_expenses_rows[14] = {
        ExpRow(EXPENSES_CONSTRUCTION, 0, 0),
        ExpRow(EXPENSES_NEW_VEHICLES, 0, 0),
        ExpRow(EXPENSES_TRAIN_RUN, 0, 0),
        ExpRow(EXPENSES_ROADVEH_RUN, 0, 0),
        ExpRow(EXPENSES_AIRCRAFT_RUN, 0, 0),
        ExpRow(EXPENSES_SHIP_RUN, 0, 0),
        ExpRow(EXPENSES_PROPERTY, 0, 0),
        ExpRow(EXPENSES_TRAIN_INC, 0, 0),
        ExpRow(EXPENSES_ROADVEH_INC, 0, 0),
        ExpRow(EXPENSES_AIRCRAFT_INC,0, 0),
        ExpRow(EXPENSES_SHIP_INC, 0, 0),
        ExpRow(EXPENSES_LOAN_INT, 0, 0),
        ExpRow(EXPENSES_OTHER, 0, 0),
...
static const NWidgetPart _nested_company_finances_widgets[] = {
	...
	NWidget(NWID_SELECTION, INVALID_COLOUR, WID_CF_SEL_BUTTONS),
        NWidget(NWID_HORIZONTAL),
            ...
            EndContainer(),
            NWidget(WWT_PANEL, COLOUR_GREY), SetMinimalSize(12, 12), SetFill(1, 0), SetResize(1, 0),
